...
#PBS -N hts_lpanamensis-hpgl0634 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0634/outputs/qsub/hts_lpanamensis-hpgl0634.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0634/scripts/hts_lpanamensis-hpgl0634.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_lpanamensis-hpgl0634.status
echo "###Finished ${PBS_JODID} hts_lpanamensis-hpgl0634.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
