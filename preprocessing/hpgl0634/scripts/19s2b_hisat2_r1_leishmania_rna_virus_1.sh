...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0634/processed/outputs/s2b_hisat2_r1_leishmania_rna_virus_1.sbatchout


echo "#### Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0634/processed/scripts/19s2b_hisat2_r1_leishmania_rna_virus_1.sh at $(date) on $(hostname)" >> outputs/log.txt
