...
#PBS -N trimst-hpgl0634 -l mem=1gb -l walltime=00:10:00 -l ncpus=1
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0634/outputs/qsub/trimst-hpgl0634.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0634/scripts/trimst-hpgl0634.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/trimst-hpgl0634.status
echo "###Finished ${PBS_JODID} trimst-hpgl0634.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
