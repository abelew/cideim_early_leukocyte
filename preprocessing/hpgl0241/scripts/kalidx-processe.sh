...
#PBS -N kalidx-processe -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/lab/nelsayed/raw_data/ade/HPGL0241/processed/outputs/qsub/kalidx-processe.qsubout -j oe -V -m n
echo "####Started /cbcb/lab/nelsayed/raw_data/ade/HPGL0241/processed/scripts/kalidx-processe.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/kalidx-processe.status
echo "###Finished ${PBS_JODID} kalidx-processe.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
