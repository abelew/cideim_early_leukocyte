...
#PBS -N hts_lpanamensis-hpgl0241 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0241/outputs/qsub/hts_lpanamensis-hpgl0241.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0241/scripts/hts_lpanamensis-hpgl0241.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_lpanamensis-hpgl0241.status
echo "###Finished ${PBS_JODID} hts_lpanamensis-hpgl0241.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
