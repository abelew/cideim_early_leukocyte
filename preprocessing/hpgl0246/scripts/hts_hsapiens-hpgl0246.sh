...
#PBS -N hts_hsapiens-hpgl0246 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0246/outputs/qsub/hts_hsapiens-hpgl0246.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0246/scripts/hts_hsapiens-hpgl0246.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_hsapiens-hpgl0246.status
echo "###Finished ${PBS_JODID} hts_hsapiens-hpgl0246.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
