...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0652/processed/outputs/hts_processed_bowtie2_lpanamensis_v36_sno_exon_gene_id.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0652/processed/scripts/21hts_processed_bowtie2_lpanamensis_v36_sno_exon_gene_id.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
