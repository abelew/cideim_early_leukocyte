...
#PBS -N hts_lmexicana-hpgl0244 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0244/outputs/qsub/hts_lmexicana-hpgl0244.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0244/scripts/hts_lmexicana-hpgl0244.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_lmexicana-hpgl0244.status
echo "###Finished ${PBS_JODID} hts_lmexicana-hpgl0244.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
