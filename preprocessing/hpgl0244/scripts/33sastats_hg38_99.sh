...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0244/processed/outputs/sastats_hg38_99.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0244/processed/scripts/33sastats_hg38_99.sh at $(date) on $(hostname)" >> outputs/log.txt
