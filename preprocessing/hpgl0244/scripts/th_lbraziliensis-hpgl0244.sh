...
#PBS -N th_lbraziliensis-hpgl0244 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0244/outputs/qsub/th_lbraziliensis-hpgl0244.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0244/scripts/th_lbraziliensis-hpgl0244.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/lbraziliensis \
  hpgl0244_forward-trimmed.fastq hpgl0244_reverse-trimmed.fastq && \
...
echo $? > outputs/status/th_lbraziliensis-hpgl0244.status
echo "###Finished ${PBS_JODID} th_lbraziliensis-hpgl0244.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
