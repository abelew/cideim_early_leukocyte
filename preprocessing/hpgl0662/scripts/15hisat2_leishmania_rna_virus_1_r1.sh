...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0662/processed/outputs/hisat2_leishmania_rna_virus_1_r1.sbatchout


echo "#### Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0662/processed/scripts/15hisat2_leishmania_rna_virus_1_r1.sh at $(date) on $(hostname)" >> outputs/log.txt
cd /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0662/processed || exit

## This is a hisat2 alignment of  -1 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0662/processed/r1.fastq.xz) -2 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0662/processed/r2.fastq.xz)  against
