...
#PBS -N hts_lbraziliensis-hpgl0655 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0655/outputs/qsub/hts_lbraziliensis-hpgl0655.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0655/scripts/hts_lbraziliensis-hpgl0655.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_lbraziliensis-hpgl0655.status
echo "###Finished ${PBS_JODID} hts_lbraziliensis-hpgl0655.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
