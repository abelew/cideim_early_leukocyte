...
#PBS -N th_hsapiens-hpgl0655 -l mem=20gb -l walltime=144:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0655/outputs/qsub/th_hsapiens-hpgl0655.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0655/scripts/th_hsapiens-hpgl0655.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/hsapiens \
  hpgl0655_forward-trimmed.fastq.gz hpgl0655_reverse-trimmed.fastq.gz && \
...
echo $? > outputs/status/th_hsapiens-hpgl0655.status
echo "###Finished ${PBS_JODID} th_hsapiens-hpgl0655.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
