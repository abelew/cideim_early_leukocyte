...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/outputs/bt2_lpanamensis_v36_r1.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/scripts/15bt2_lpanamensis_v36_r1.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
cd /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed || exit

## This is a bowtie2 alignment of  -1 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/r1.fastq.xz) -2 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/r2.fastq.xz)  against
...
mkdir -p outputs/bowtie2_lpanamensis_v36 && \
  ...
  bowtie2 -x /cbcbhomes/abelew/libraries/genome/indexes/lpanamensis_v36  --very-sensitive -L 14  \
    -p 4 \
    -q   -1 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/r1.fastq.xz) -2 <(less /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0636/processed/r2.fastq.xz)  \
