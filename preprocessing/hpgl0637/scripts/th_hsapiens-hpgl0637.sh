...
#PBS -N th_hsapiens-hpgl0637 -l mem=20gb -l walltime=144:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0637/outputs/qsub/th_hsapiens-hpgl0637.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0637/scripts/th_hsapiens-hpgl0637.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/hsapiens \
  hpgl0637_forward-trimmed.fastq.gz hpgl0637_reverse-trimmed.fastq.gz && \
...
echo $? > outputs/status/th_hsapiens-hpgl0637.status
echo "###Finished ${PBS_JODID} th_hsapiens-hpgl0637.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
