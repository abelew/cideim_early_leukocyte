...
#PBS -N hts_hsapiens-hpgl0630 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0630/outputs/qsub/hts_hsapiens-hpgl0630.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0630/scripts/hts_hsapiens-hpgl0630.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_hsapiens-hpgl0630.status
echo "###Finished ${PBS_JODID} hts_hsapiens-hpgl0630.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
