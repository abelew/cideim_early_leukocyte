...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0630/processed/outputs/sal_hg38_99.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0630/processed/scripts/30sal_hg38_99.sh at $(date) on $(hostname)" >> outputs/log.txt
