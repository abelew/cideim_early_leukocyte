...
#PBS -N th_lbraziliensis-hpgl0630 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0630/outputs/qsub/th_lbraziliensis-hpgl0630.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0630/scripts/th_lbraziliensis-hpgl0630.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/lbraziliensis \
  hpgl0630_forward-trimmed.fastq hpgl0630_reverse-trimmed.fastq && \
...
echo $? > outputs/status/th_lbraziliensis-hpgl0630.status
echo "###Finished ${PBS_JODID} th_lbraziliensis-hpgl0630.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
