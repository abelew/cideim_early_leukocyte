...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0635/processed/outputs/xzun_bt2_r1.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0635/processed/scripts/16xzun_bt2_r1.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
