...
#PBS -N trimst-hpgl0635 -l mem=1gb -l walltime=00:10:00 -l ncpus=1
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0635/outputs/qsub/trimst-hpgl0635.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0635/scripts/trimst-hpgl0635.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/trimst-hpgl0635.status
echo "###Finished ${PBS_JODID} trimst-hpgl0635.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
