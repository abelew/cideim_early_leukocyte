...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0635/processed/outputs/parsesnp_lpanamensis_v36.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0635/processed/scripts/81parsesnp_lpanamensis_v36.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
...
/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0635/processed/scripts/81parsesnp_lpanamensis_v36.pl
