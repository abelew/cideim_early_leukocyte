...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0632/processed/outputs/sal_hg38_91.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0632/processed/scripts/30sal_hg38_91.sh at $(date) on $(hostname)" >> outputs/log.txt
