...
#PBS -N th_lbraziliensis-hpgl0632 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0632/outputs/qsub/th_lbraziliensis-hpgl0632.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0632/scripts/th_lbraziliensis-hpgl0632.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/lbraziliensis \
  hpgl0632_forward-trimmed.fastq hpgl0632_reverse-trimmed.fastq && \
...
echo $? > outputs/status/th_lbraziliensis-hpgl0632.status
echo "###Finished ${PBS_JODID} th_lbraziliensis-hpgl0632.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
