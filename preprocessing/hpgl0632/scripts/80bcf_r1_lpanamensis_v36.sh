...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0632/processed/outputs/bcf_r1_lpanamensis_v36.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0632/processed/scripts/80bcf_r1_lpanamensis_v36.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
