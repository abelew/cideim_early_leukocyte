...
#PBS -N hts_hsapiens-hpgl0632 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0632/outputs/qsub/hts_hsapiens-hpgl0632.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0632/scripts/hts_hsapiens-hpgl0632.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_hsapiens-hpgl0632.status
echo "###Finished ${PBS_JODID} hts_hsapiens-hpgl0632.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
