...
#PBS -N th_lbraziliensis-hpgl0245 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0245/outputs/qsub/th_lbraziliensis-hpgl0245.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0245/scripts/th_lbraziliensis-hpgl0245.sh at $(date)" >> outputs/log.txt
...
/cbcbhomes/abelew/libraries/genome/indexes/lbraziliensis \
  hpgl0245_forward-trimmed.fastq hpgl0245_reverse-trimmed.fastq && \
...
echo $? > outputs/status/th_lbraziliensis-hpgl0245.status
echo "###Finished ${PBS_JODID} th_lbraziliensis-hpgl0245.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
