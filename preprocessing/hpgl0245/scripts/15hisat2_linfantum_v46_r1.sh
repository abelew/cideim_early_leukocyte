...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0245/processed/outputs/hisat2_linfantum_v46_r1.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0245/processed/scripts/15hisat2_linfantum_v46_r1.sh at $(date) on $(hostname)" >> outputs/log.txt
