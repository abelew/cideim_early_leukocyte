...
#SBATCH --workdir=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0245/processed
...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0245/processed/outputs/sal_lpanamensis_v36.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0245/processed/scripts/30sal_lpanamensis_v36.sh at $(date) on $(hostname)" >> outputs/log.txt
