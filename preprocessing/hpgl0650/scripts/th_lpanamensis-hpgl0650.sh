...
#PBS -N th_lpanamensis-hpgl0650 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0650/outputs/qsub/th_lpanamensis-hpgl0650.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0650/scripts/th_lpanamensis-hpgl0650.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/th_lpanamensis-hpgl0650.status
echo "###Finished ${PBS_JODID} th_lpanamensis-hpgl0650.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
