...
#PBS -N th_lmajor-hpgl0243 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0243/outputs/qsub/th_lmajor-hpgl0243.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0243/scripts/th_lmajor-hpgl0243.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/th_lmajor-hpgl0243.status
echo "###Finished ${PBS_JODID} th_lmajor-hpgl0243.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
