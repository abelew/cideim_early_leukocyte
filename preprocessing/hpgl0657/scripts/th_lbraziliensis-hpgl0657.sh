...
#PBS -N th_lbraziliensis-hpgl0657 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0657/outputs/qsub/th_lbraziliensis-hpgl0657.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0657/scripts/th_lbraziliensis-hpgl0657.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/th_lbraziliensis-hpgl0657.status
echo "###Finished ${PBS_JODID} th_lbraziliensis-hpgl0657.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
