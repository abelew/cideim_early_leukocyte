...
#SBATCH --workdir=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0638/processed
...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0638/processed/outputs/sal_lpanamensis_v36.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0638/processed/scripts/30sal_lpanamensis_v36.sh at $(date) on $(hostname)" >> outputs/log.txt
cd /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0638/processed || exit

## This is a salmon pseudoalignment of forward.fastq.xz:reverse.fastq.xz against
...
salmon quant -i /cbcbhomes/abelew/libraries/genome/indexes/lpanamensis_v36_salmon_index \
  -l A --gcBias  \
   -1 <(less forward.fastq.xz) -2 <(less reverse.fastq.xz)  \
