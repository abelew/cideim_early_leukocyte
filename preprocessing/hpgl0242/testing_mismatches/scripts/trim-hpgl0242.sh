...
#PBS -d /cbcb/lab/nelsayed/raw_data/ade/HPGL0242/processed/testing_mismatches
#PBS -N trim-hpgl0242 -l mem=6gb -l walltime=4:00:00 -l ncpus=4
#PBS -o /cbcb/lab/nelsayed/raw_data/ade/HPGL0242/processed/testing_mismatches/outputs/qsub/trim-hpgl0242.qsubout -j oe -V -m n
echo "####Started /cbcb/lab/nelsayed/raw_data/ade/HPGL0242/processed/testing_mismatches/scripts/trim-hpgl0242.sh at $(date)" >> outputs/log.txt
cd /cbcb/lab/nelsayed/raw_data/ade/HPGL0242/processed/testing_mismatches || exit
