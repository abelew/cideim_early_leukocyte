...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0242/processed/outputs/htall_hisat2_r1.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0242/processed/scripts/21htall_hisat2_r1.sh at $(date) on $(hostname)" >> outputs/log.txt
