...
#PBS -N hts_lmajor-hpgl0242 -l mem=6gb -l walltime=10:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0242/outputs/qsub/hts_lmajor-hpgl0242.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/old/hpgl0242/scripts/hts_lmajor-hpgl0242.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/hts_lmajor-hpgl0242.status
echo "###Finished ${PBS_JODID} hts_lmajor-hpgl0242.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
