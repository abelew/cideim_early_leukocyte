...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0242/processed/outputs/hisat2_ldonovani_v46_r1.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0242/processed/scripts/15hisat2_ldonovani_v46_r1.sh at $(date) on $(hostname)" >> outputs/log.txt
