...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0653/processed/outputs/ht2st_hisat2_r1.sbatchout


echo "#### Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0653/processed/scripts/18ht2st_hisat2_r1.sh at $(date) on $(hostname)" >> outputs/log.txt
