...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0660/processed/outputs/bt2st_bt2_r1.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0660/processed/scripts/18bt2st_bt2_r1.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
