...
#PBS -N th_lpanamensis-hpgl0639 -l mem=8gb -l walltime=18:00:00 -l ncpus=4
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0639/outputs/qsub/th_lpanamensis-hpgl0639.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0639/scripts/th_lpanamensis-hpgl0639.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/th_lpanamensis-hpgl0639.status
echo "###Finished ${PBS_JODID} th_lpanamensis-hpgl0639.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
