...
#PBS -N trimst-hpgl0633 -l mem=1gb -l walltime=00:10:00 -l ncpus=1
#PBS -o /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0633/outputs/qsub/trimst-hpgl0633.qsubout -j oe -V -m n
echo "####Started /cbcb/nelsayed-scratch/atb/rnaseq_lpanamensis/preprocessing/hpgl0633/scripts/trimst-hpgl0633.sh at $(date)" >> outputs/log.txt
...
echo $? > outputs/status/trimst-hpgl0633.status
echo "###Finished ${PBS_JODID} trimst-hpgl0633.sh at $(date), it took $(( $SECONDS / 60 )) minutes." >> outputs/log.txt
