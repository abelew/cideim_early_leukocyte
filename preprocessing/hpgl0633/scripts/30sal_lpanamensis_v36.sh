...
#SBATCH --workdir=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0633/processed
...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0633/processed/outputs/sal_lpanamensis_v36.sbatchout


echo "####Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0633/processed/scripts/30sal_lpanamensis_v36.sh at $(date) on $(hostname)" >> outputs/log.txt
