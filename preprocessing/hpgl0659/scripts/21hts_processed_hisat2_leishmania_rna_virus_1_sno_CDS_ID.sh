...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0659/processed/outputs/hts_processed_hisat2_leishmania_rna_virus_1_sno_CDS_ID.sbatchout


echo "#### Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0659/processed/scripts/21hts_processed_hisat2_leishmania_rna_virus_1_sno_CDS_ID.sh at $(date) on $(hostname)" >> outputs/log.txt
