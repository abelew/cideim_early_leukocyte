...
#SBATCH --output=/fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0659/processed/outputs/s2b_bt2_r1_lpanamensis_v36.sbatchout


echo "## Started /fs/cbcb-lab/nelsayed/raw_data/ade/HPGL0659/processed/scripts/19s2b_bt2_r1_lpanamensis_v36.sh at $(date) on $(hostname) with id ${SLURM_JOBID}." >> outputs/log.txt
