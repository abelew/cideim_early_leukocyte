...
plt <- plot_pca(pbmc_norm, plot_labels=FALSE)$plot
pp(file="figures/fig_2a.tiff", image=plt)
plt
...
pp(file="figures/fig_2b.tif", image=plt)
plt
...
pp(file="figures/fig_2c.tiff", image=plt)
plt
...
pp(file="images/pbmc_s1_libsize.pdf", image=pbmc_s1_libsize$plot)
...
pp(file="images/pbmc_s1_disheat.pdf", image=pbmc_s1_heat)
```
